...
var gameApi = __webpack_require__(6);

store.gameBoard = ['', '', '', '', '', '', '', '', ''];

var isEmpty = function isEmpty(cellId) {
...
var markCell = function markCell(cellId) {
...
var checkForWin = function checkForWin(cellId) {
  if (store.gameBoard[0] === store.player && store.gameBoard[1] === store.player && store.gameBoard[2] === store.player) {
    gameApi.endGame(cellId).then(gameUi.updateGameSuccess).catch(gameUi.updateGameError);
    gameUi.winMessage();
...
var moveNotAllowed = function moveNotAllowed() {
  $('#error').modal('show');
};
...
var grabOverGamesX = function grabOverGamesX(response) {
  return gameApi.getGameByUserOver().then(gameUi.getGamesSuccess).catch(gameUi.getGamesError);
};

var calculateWinsNumberX = function calculateWinsNumberX() {
  var winCount = 0;
  var checkValue = 'x';
  store.player_x.wins = winCount;
  for (var i = 0; i < store.games.games.length; i++) {
...
module.exports = {
  ...
  gameReset: gameReset,
  grabOverGamesX: grabOverGamesX,
  calculateWinsNumberX: calculateWinsNumberX
};
...
var store = __webpack_require__(1);
var gameLogic = __webpack_require__(2);
...
var signUpError = function signUpError(response) {
  $('#error').modal('show');
  $('#sign-up-form')[0].reset();
};
...
var signInSuccessX = function signInSuccessX(response) {
...
var changePasswordSuccessX = function changePasswordSuccessX(response) {
...
var changePasswordError = function changePasswordError(_changePasswordError) {
  $('#error').modal('show');
  $('#change-password-x-form')[0].reset();
};

var logOutSuccessX = function logOutSuccessX(response) {
...
var logOutError = function logOutError(_logOutError) {
  $('#error').modal('show');
};
...
module.exports = {
  ...
  signInSuccessX: signInSuccessX,
  changePasswordSuccessX: changePasswordSuccessX,
  changePasswordError: changePasswordError,
  logOutSuccessX: logOutSuccessX,
...
var createGameError = function createGameError(_createGameError) {
  $('#error').modal('show');
};

var updateGameSuccess = function updateGameSuccess(response) {
  // $('#game-messages').text(`Move saved successfully`)
};

var updateGameError = function updateGameError() {
  $('#error').modal('show');
};
...
var getGamesError = function getGamesError(response) {
  $('#error').modal('show');
};
...
var updateGame = function updateGame(cellId) {
  var data = {
    'game': {
      'cell': {
        'index': cellId - 1,
...
var endGame = function endGame(cellId) {
  var data = {
    'game': {
      'cell': {
        'index': cellId - 1,
...
var getGameById = function getGameById() {
  return $.ajax({
    method: 'GET',
    url: config.apiUrl + 'games/' + store.game.id,
    headers: {
...
var getGameByUser = function getGameByUser() {
  return $.ajax({
    method: 'GET',
    url: config.apiUrl + 'games',
    headers: {
...
var getGameByUserOver = function getGameByUserOver() {
  return $.ajax({
    method: 'GET',
...
module.exports = {
  ...
  getGameByUserOver: getGameByUserOver
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var authApi = __webpack_require__(13);
...
var onSignInX = function onSignInX(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  authApi.signInX(data).then(authUi.signInSuccessX).then(gameLogic.grabOverGamesX).then(gameLogic.calculateWinsNumberX).then(function () {
    return $('#player-x-wins').text('You have won ' + store.player_x.wins + ' games!!');
  }).catch(authUi.signInError);
};

var onChangePasswordX = function onChangePasswordX(event) {
  event.preventDefault();
  // console.log('the change password form for player x was submitted')
  var data = getFormFields(event.target);
  // console.log('data is', data)
  authApi.changePasswordX(data).then(authUi.changePasswordSuccessX).catch(authUi.changePasswordError);
};

var onLogOutX = function onLogOutX(event) {
  // console.log('the log out player x button was clicked')
  event.preventDefault();
  authApi.logOutX().then(authUi.logOutSuccessX).catch(authUi.logOutError);
};

module.exports = {
  onSignUp: onSignUp,
  onSignInX: onSignInX,
  onChangePasswordX: onChangePasswordX,
  onLogOutX: onLogOutX
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var signInX = function signInX(data) {
  return $.ajax({
    method: 'POST',
...
var changePasswordX = function changePasswordX(data) {
  return $.ajax({
    method: 'PATCH',
...
module.exports = {
  signUp: signUp,
  signInX: signInX,
  changePasswordX: changePasswordX,
  logOutX: logOutX
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var onClick = function onClick() {
  ...
  if (gameLogic.isEmpty(cellId)) {
    ...
    gameApi.updateGame(cellId).then(gameUi.updateGameSuccess).then(function () {
      return gameLogic.checkForWin(cellId);
    }).then(gameLogic.switchPlayer).catch(gameUi.updateGameError);
  } else {
    gameLogic.moveNotAllowed();
  }
};

var onPlayAgain = function onPlayAgain() {
  gameLogic.gameReset();
  $('#draw').modal('hide');
  $('#winner').modal('hide');
  gameApi.createGame().then(gameUi.createGameSuccess).catch(gameUi.createGameError);
};
...
var onHideBoard = function onHideBoard() {
  gameLogic.gameReset();
  gameUi.hideBoard();
};
